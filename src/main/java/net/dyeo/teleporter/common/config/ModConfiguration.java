...
public final class ModConfiguration
{
	...
	public static void preInit()
	{
		...
		Property propUseDiamonds = config.get(Configuration.CATEGORY_GENERAL, "useDiamonds", useDiamonds, "If false, removes diamonds from the crafting recipe and replaces them with iron (regular) or obsidian (ender) blocks.\n" +
				"When using the /recipe command, the diamond recipes are teleporter:regular/teleporter , teleporter:regular/ender_teleporter and the diamondless recipes are teleporter:simple/teleporter , teleporter:simple/ender_teleporter\n" +
				"Default is true");
