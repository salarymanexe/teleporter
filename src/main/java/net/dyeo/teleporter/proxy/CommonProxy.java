...
public class CommonProxy implements ISidedProxy
{
	...
	void initConfiguration(FMLPreInitializationEvent event)
	{
		...
		config.addCustomCategoryComment(Configuration.CATEGORY_GENERAL,
				"Vanilla-Inspired Teleporters Version " + Reference.VERSION + " Configuration");
	...
	void initBlocks()
	{
		...
		GuiHandlerRegistry.getInstance().registerGuiHandler(new GuiHandlerTeleporter(),
				GuiHandlerTeleporter.getGuiID());
	}
