...
public class CapabilityTeleporterEntity {
    ...
    {
        @Override public NBTBase writeNBT(Capability<ITeleporterEntity> capability, ITeleporterEntity instance, EnumFacing side) { return null; }
        @Override public void readNBT(Capability<ITeleporterEntity> capability, ITeleporterEntity instance, EnumFacing side, NBTBase nbt) {}
    }
