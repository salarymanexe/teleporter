...
public class BlockRenderRegister {
	...
	public static void reg(Block block) {
	    ...
	    .register(Item.getItemFromBlock(block), 0, new ModelResourceLocation(Reference.MODID.toLowerCase() + ":" + block.getUnlocalizedName().substring(5), "inventory"));
	}
	
	public static void reg(Block block, int meta, String file) {
	    Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
	    .register(Item.getItemFromBlock(block), meta, new ModelResourceLocation(Reference.MODID.toLowerCase() + ":" + file, "inventory"));
	}
